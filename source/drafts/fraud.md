...
You get a recruiter reaching out on LinkedIn, and it seems to be a *perfect* opportunity, tailored exactly to your best skills. 
...
You hear back from them: someone else got the job. Oh well. They did however enjoy talking to you and might reach out for future similar opportunities. Back to the grind.

Six months later, you learn: your identity has been stolen, and thousands have been spent on credit cards opened in your name. You no longer have access to your email. Your brokerage account has been partially drained. It's going to take months to disentangle this, and you're likely not going to get everything back.
...
This is pretty scary already, but I mentioned they drained your funds as well, which requires a lot more complexity. Modern financial systems have a lot of protection against hijacked accounts: most scams targeting money involve convincing someone to voluntarily transfer a bunch of money in an irreversible or untraceable way, and a tech-savvy professional is less likely to be the target of that. Initiating a bank transfer via online banking would likely be noticed by the user, transfers take a few days, and the target account could be traced due to KYC regs. Banking sites often use 2FA and text the user.

But one can work around a lot of this, for example (unsuspecting) [money mules] are a preexisting way to avoid being traced after a fraudulent transfer. Someone with persistent, undetected access to your email and accounts may notice, for example, that you have paycheck money autotransfering to a brokerage account that you don't seem to touch or log in to often (by the dearth of "login detected to foo.com" emails). They might gain access to it by resetting your password (and deleting the notification), add a transfer account, and establish a pattern of usage making small transfers. Maybe they can wait for you to be on vacation, because they know when that is: they have your calendar! 


I mean, yeah, depending on a lot of the details, that sounds moderately plausible, right? But it's a *lot* of work, would it even be worth it?

Well, I left out one part. This entire attack was orchestrated and carried out by an LLM.

An LLM which could research everything about you; craft a tailored attack, put together all the things that would be needed to make this seem plausible (a LinkedIn account, a fake document signing website, a plausible-looking domain to send emails from), and synthesize all text, audio and video interactions. An LLM which could monitor your account and find the best ways to make use of that access, whether it be worming its way into your brokerage, racking up huge cloud spends on AWS, taking all your crypto, or even ransoming your decades of precious data from your now-stolen, likely-wiped account.
...
Spray-and-pray scams are cheap because they often spend no effort in convincing you. In fact, the "Nigerian Scammer" trope exists because [it benefits scammers running scams against less-savvy individuals that the more-savvy individuals self-select out of it as early as possible][nigerian-why]. Emails are free, but the subsequent work to correspond with and scam a mark is not.

Tech-savvy people are, by and large, not *super* prone to these scams. One can pick up a bunch of computer security best practices, paired with a rough understanding of the capabilities inherent in the system[^1], and be reasonably secure against this stuff.

However, with respect to more sophisticated scams, most people don't have $25M buttons available to them at work.

Sure, many professionals have enough savings that it would make sense to mount a sophisticated scam, but also the likelihood of it happening to you is slight: A scam that takes that amount of effort takes a lot of setup time and can't just be scaled up; you need people with the sophistication to run this scam willing to become criminals, and that just doesn't parallelize.

(Sophisticated attacks like this against individual wealth [do happen though][the-cut] [^2])
...
Correction, *was* bimodal. LLMs fill the middle of the distribution. They're pretty cheap: [A 2024 paper][heiding] found that LLMs _from that era_, tasked with spearphishing, cost around 4¢ per email. The interview scam laid out above is more involved and more expensive, but likely still worth it.
